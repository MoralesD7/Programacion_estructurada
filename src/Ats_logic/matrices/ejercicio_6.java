...
public class ejercicio_6 {
    public static void main(String[] args) {
        ...
        try (Scanner sc = new Scanner(System.in);) {
            ...
            // ciclos para asegurar que se interten valores positivos en la cantidad de
            // datos de la matriz
            do {
                // Solicitar los datos
            ...
            int[][] array_2 = new int[n_columnas_1][n_filas_1];
            ...
            for (int i = 0; i < n_columnas_1; i++) {
                for (int j = 0; j < n_filas_1; j++) {
